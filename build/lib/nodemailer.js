...
exports.sendBuyerRequestConfirmationEmail = sendBuyerRequestConfirmationEmail;
...
function sendVerificationEmail(firstName, email, otp) {
...
function sendRequestApprovalEmail(firstName, email, otp, deliverTo, title) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield transporter.sendMail({
                from: process.env.USER_EMAIL_ID,
...
function sendBuyerRequestConfirmationEmail(firstName, buyerName, buyerId, deliverTo, bookTitle, email) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield transporter.sendMail({
                from: process.env.USER_EMAIL_ID,
        ...
        <div style="font-family: Arial, sans-serif; color: #333333; background-color: #FDF6EC; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #FF6700; border-radius: 10px;">
          ...
          <p>Good news! Your book "<strong>${bookTitle}</strong>" has been requested by <a href=${process.env.FRONTEND_URL + "/user/" + buyerId} target="_blank"><strong>${buyerName}</strong></a>.</p>
